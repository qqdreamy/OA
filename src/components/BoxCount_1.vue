...
<div>
  ...
  <el-dialog title="天地盖-盖到底" v-model="dialogTableVisible" size="large">
    ...
    <el-col :span="20">
    底(外空)：{{topInnerLong-bottomBack}}*{{topInnerWide-bottomBack}}*{{height-thick}}
    底(内空)：{{long-thick*4-bottomBack}}*{{wide-thick*4-bottomBack}}*{{height-thick*2}}
    </el-col>
...
export default {
  ...
  computed:{
    ...
    bottomCardboardLong:function(){
      return (Number(this.topInnerLong-this.bottomBack)+Number(this.bottomHeight)*2);
    },
    bottomCardboardWide:function(){
      return (Number(this.topInnerWide-this.bottomBack)+Number(this.bottomHeight)*2);
    },
    ...
    bottomColorSurfaceLong:function(){
      return (this.long-this.thick*2-this.bottomBack)+(this.bottomHeight)*2+this.curling*2+this.thick*2+1;
    },
    bottomColorSurfaceWide:function(){
      return (this.wide-this.thick*2-this.bottomBack)+(this.bottomHeight)*2+this.curling*2+this.thick*2+1;
    }
  },
  methods:{
    updateID:function(aa){
      this.id=aa;//子组件调用修改
    },
    Print:function(){
    ...
    test:function(e){
      this.$nextTick(function () {
         ...
         this.bottomHeight=Math.floor(this.height-this.thick);
      });
    },
    ...
    Count:function(){
      ...
      this.$nextTick(function () {
        ...
        SizeCount.TopBottomdDevelopment('bottomDevelopment',this.topInnerLong-this.bottomBack,this.topInnerWide-this.bottomBack,this.bottomHeight,'底盒');
