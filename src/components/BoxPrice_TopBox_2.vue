  ...
  methods:{
    ...
    CountPrice:function(){
      ...
      if(this.isCardboard=='含纸板'){//判断是否含纸板
        ...
        this.boxPrice.bottomCardboard=js_CountPrice.Cardboard(this.bottomCardboardLong+this.changeNumber,this.bottomCardboardWide+this.changeNumber,this.BottomCardboard,this.bThick,true).toFixed(2);
        if(this.technique=='1'){
      ...
      cuttQuantity+=2;
        ...
        //加工费
        this.boxPrice.process=js_CountPrice.Process('天地盖2',this.quantity);
        //覆膜
        if(this.film){
